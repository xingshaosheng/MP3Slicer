...
public class MP3Slicer {
    ...
    public static List<byte[]> split(File sourceFile,long segmentSize) throws InvalidDataException, UnsupportedTagException, IOException {
    ...
    public static byte[] split(File sourceFile,int startSecond,int endSecond) throws InvalidDataException, UnsupportedTagException, IOException {
        Mp3File mp3File = new Mp3File(sourceFile);
